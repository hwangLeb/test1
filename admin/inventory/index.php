...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=inventory/manage_inventory" class="btn btn-primary"><span class="fas fa-plus"></span>  Create New</a>
		</div>
	</div>
	<div class="card-body">
				...
				<tbody>
					...
					?>
						<tr>
							...
							<td>
								<p class="m-0"><small><b>Item:</b> <?php echo $row['product'] ?></small></p>
