                    ...
                    <div class="d-flex align-items-center">
                      <?php if(!isset($_SESSION['userdata']['id'])): ?>
                        ...
                        <a class="text-dark mr-2 nav-link" href="./?p=cart">
                            <i class="bi-cart-fill me-1 fas fa-shopping-cart" ></i>
                            <!--Cart-->
                            ...
                            <a href="./?p=my_account" class="text-dark  nav-link"><b> 안녕, <?php echo $_settings->userdata('firstname')?>!</b></a>
                            <button href="logout.php" class="text-light button  nav-link" onClick="confirmLogout()"><i class="fa fa-sign-out-alt">Logout</i></button>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
