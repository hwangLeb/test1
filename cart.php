    ...
    <div class="container">
        <div class="row">
            <div class="col d-flex justify-content-end mb-2">
                <button class="btn btn-outline-red  btn-sm" type="button" id="empty_cart">Empty Cart</button>
            </div>
        </div>
                            ...
                            <div>
                                ...
                                <div class="input-group" style="width:130px !important">
                                    <div class="input-group-prepend">
                                        <button class="btn btn-sm btn-outline-tertiary min-qty" type="button" id="button-addon1"><i class="fa fa-minus"></i></button>
                                    </div>
        ...
        <div class="d-flex w-100 justify-content-end">
            ...
            <a href="./?p=checkout" class="btn btn-dark fas fa-credit-card" > Checkout</a>
        </div>
    </div>
</section>
<script>
